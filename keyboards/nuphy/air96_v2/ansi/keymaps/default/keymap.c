...
[M_LAYER] = LAYOUT_96_ansi(
   ...
   _______,   _______,   _______,   _______,     _______,      SIDE_1,    KC_MS_WH_UP, KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2, _______,    _______,    SLEEP_NOW,   _______,                _______,   _______,   _______,   _______,
