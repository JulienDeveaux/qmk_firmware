...
// layer 0 Mac (customized from VIA export)
[MAC_BASE] = LAYOUT_96_ansi(
   KC_ESC,    KC_BRID,   KC_BRIU,   C(KC_F10),   A(KC_SPC),    KC_F20,    G(KC_L),   KC_MPRV,     KC_MPLY,   KC_MNXT,    KC_MUTE,    KC_VOLD,    KC_VOLU,     G(S(KC_COMM)), KC_DEL,  KC_HOME,   KC_END,    KC_PGUP,   KC_PGDN,
   KC_GRV,    KC_1,      KC_2,      KC_3,        KC_4,         KC_5,      KC_6,      KC_7,        KC_8,      KC_9,       KC_0,       KC_MINS,    KC_EQL,      KC_BSPC,               NUMLOCK_INS, KC_PSLS, KC_PAST,   KC_PMNS,
   KC_TAB,    KC_Q,      KC_W,      KC_E,        KC_R,         KC_T,      KC_Y,      KC_U,        KC_I,      KC_O,       KC_P,       KC_LBRC,    KC_RBRC,     KC_BSLS,               KC_P7,     KC_P8,     KC_P9,     KC_PPLS,
   LT(4,KC_CAPS), KC_A,  KC_S,      KC_D,        KC_F,         KC_G,      KC_H,      KC_J,        KC_K,      KC_L,       KC_SCLN,    KC_QUOT,    KC_ENT,                             KC_P4,     KC_P5,     KC_P6,
...
[MAC_FN] = LAYOUT_96_ansi(
   ...
   _______,   _______,   _______,   _______,     _______,      _______,   _______,   _______,     _______,   _______,    _______,    DEV_RESET,  BAT_SHOW,    BAT_NUM,               _______,   _______,   _______,   _______,
   _______,   _______,   _______,   _______,     _______,      _______,   _______,   _______,     _______,   _______,    _______,    _______,    _______,                            _______,   _______,   _______,
   _______,              _______,   _______,     _______,      _______,   BAT_NUM,   _______,     MO(4),     _______,    _______,    _______,    _______,                RM_VALU,    SIDE_VAI,  _______,   _______,   _______,
   _______,   _______,   _______,                              _______,                                                  RSFT(RALT(KC_W)),    _______,    RSFT(RALT(KC_X)),     _______,   RM_VALD,    SIDE_VAD,  _______,   _______),
// layer 2 win
...
[WIN_FN] = LAYOUT_96_ansi(
   ...
   _______,   _______,   _______,   _______,     _______,      _______,   _______,   _______,     _______,   _______,    _______,    DEV_RESET,  BAT_SHOW,    BAT_NUM,                _______,  _______,   _______,   _______,
   _______,   _______,   _______,   _______,     _______,      _______,   _______,   _______,     _______,   _______,    _______,    _______,    _______,                             _______,  _______,   _______,
   _______,              _______,   _______,     _______,      _______,   _______,   _______,     MO(4),     _______,    _______,    _______,    _______,                _______,     _______,  _______,   _______,   _______,
   _______,   _______,   _______,                              _______,                                                  _______,    _______,    _______,     _______,   _______,     _______,  _______,   _______),
// layer 4 function + mouse (from VIA export - mouse on Y/U/I/O and H/J/K/L and N/M)
[M_LAYER] = LAYOUT_96_ansi(
   ...
   _______,   _______,   _______,   _______,     _______,      _______,   KC_MS_WH_UP, KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2, _______,    _______,    SLEEP_NOW,   _______,                _______,   _______,   _______,   _______,
   CAPS_WORD, _______,   _______,   DEBOUNCE_T,  SOCD_TOG,     GAME_MODE, KC_MS_WH_DOWN, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, _______,_______,    _______,                             _______,   _______,   _______,
   _______,              SIDE_SPD,  _______,     _______,      _______, NUMLOCK_IND, KC_MS_WH_LEFT, KC_MS_WH_RIGHT, _______,  SIDE_SPI, _______,  _______,                SIDE_VAI,    _______,   _______,   _______,   _______,
